...
/// Resource for the enemy registry.
...
pub struct EnemyRegistryEntry {
    /// Registered enemy pack.
    pub pack: RegisteredEnemyPack,
    /// Registered enemies in the enemy pack.
...
/// Container for the registered enemy packs.
#[derive(Debug)]
...
/// Container for the registered enemies.
#[derive(Debug)]
...
impl RegisteredEnemy {
    /// Gets whether the enemy has the tag.
