...
/// Gets the localized text of the refresh buttons.
pub fn refresh_button(refresh_cost: Balance) -> LocalizedText {
    LocalizedText::Localized {
        key: "ui-refresh-button",
        args: smallvec![("cost", format_smolstr!("{}", refresh_cost))],
        fallback: format!("Refresh - {}", refresh_cost).into(),
    }
}

/// Gets the localized text of the lock buttons.
pub fn lock_button() -> LocalizedText {
    LocalizedText::Localized { key: "ui-lock-button", args: smallvec![], fallback: "Lock".into() }
}

/// Gets the localized text of the unlock buttons.
pub fn unlock_button() -> LocalizedText {
    LocalizedText::Localized {
        key: "ui-unlock-button",
        args: smallvec![],
        fallback: "Unlock".into(),
    }
}

/// Gets the localized text of the continue buttons.
pub fn continue_button() -> LocalizedText {
    LocalizedText::Localized {
        key: "ui-continue-button",
        args: smallvec![],
