...
impl RegisteredSystems {
    ...
    pub fn initialize(app: &mut App) {
        ...
        let market = RegisteredMarketSystems::register(app, systems);
        let widget = RegisteredWidgetSystems::register(app, systems);

        app.insert_resource(RegisteredSystems {
            configuration,
            leveling,
            localization,
            market,
...
pub struct RegisteredConfigurationSystems {
    /// Registered [start_in_game](crate::systems::configuration::start_in_game) system.
...
pub struct RegisteredLevelingSystems {
    /// Registered [set_level](crate::systems::leveling::set_level) system.
...
pub struct RegisteredLocalizationSystems {
    /// Registered [set_locale](crate::systems::localization::set_locale) system.
...
impl RegisteredLocalizationSystems {
    ...
    pub fn register(app: &mut App, registered_systems: Entity) -> RegisteredLocalizationSystems {
        use crate::systems::localization::*;
...
/// Container for the registered market systems.
#[derive(Debug)]
pub struct RegisteredMarketSystems {
    /// Registered [refresh_market](crate::systems::market::refresh_market) system.
    pub refresh_market: SystemId<()>,
}

impl RegisteredMarketSystems {
    /// Registers appropriate market systems.
    pub fn register(app: &mut App, registered_systems: Entity) -> RegisteredMarketSystems {
        use crate::systems::market::*;

        let refresh_market = app.world_mut().register_system(refresh_market);
        RegisteredSystems::attach(app, registered_systems, refresh_market, "refresh_market");
...
pub struct RegisteredWidgetSystems {
    /// Registered [save_selected_widget](crate::systems::ui::widget::save_selected_widget) system.
    pub save_selected_widget: SystemId,

    /// Registered [restore_selected_widget](crate::systems::ui::widget::restore_selected_widget) system.
