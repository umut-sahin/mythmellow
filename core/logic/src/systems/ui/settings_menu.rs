...
pub fn spawn_settings_menu(
    ...
    commands
        .ui_builder(UiRoot)
        .column(|root| {
            // Spawn the language settings.
            root.container(NodeBundle::default(), |container| {
                // Spawn the previous button.
                container
            ...
            root.menu_button(localization::back_button(), localization.deref(), ui_font.clone())
                .named("Back Button")
